...
class TugasController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('pages.guru.tugas.index', compact('tugas', 'jadwal', 'kelas'));
    }
    ...
    public function nilaiSiswa()
    {
        ...
        return view('pages.siswa.nilai.index', compact('tugas', 'guru', 'kelas', 'jawaban'));
    }
     ...
     * @return \Illuminate\Http\Response
     */
    public function kirimNilai(Request $request, $id)
    {
