                                    ...
                                    <form action="{{ route('update.profile') }}" method="POST" enctype="multipart/form-data">
                                        ...
                                        <div class="card-body">
                                            <div class="text-center">
                                                @if(isset($siswa->foto))
                                                    <img src="{{ url(Storage::url($siswa->foto)) }}" style="width: 150px; height:150px; object-fit:cover;" alt="foto siswa" class="rounded-circle mb-4">
                                                @else
                                                    <img src="{{asset('/img/image.png')}}" style="width: 150px; height:150px; object-fit:cover;" alt="foto siswa" class="rounded-circle mb-4">
                                                @endif
                                            </div>
