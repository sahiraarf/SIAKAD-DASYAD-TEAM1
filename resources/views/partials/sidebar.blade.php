<div class="main-sidebar">
    <aside id="sidebar-wrapper sidebar-nav">
        ...
        <ul class="sidebar-menu">
            ...
            <li class="{{ request()->routeIs('nilai.*') ? 'active' : '' }}"><a class="nav-link" href="{{ route('siswa.nilai') }}"><i class="fas fa-pen"></i> <span>Nilai</span></a></li>
